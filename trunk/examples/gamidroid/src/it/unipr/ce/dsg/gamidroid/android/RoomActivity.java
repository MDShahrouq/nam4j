...
public class RoomActivity extends ListActivity implements ResourceListener {
					...
					if(selectedRoom != null) {
						...
						runOnUiThread(new Runnable() {
							public void run() {
						        ...
						        ArrayAdapter<String> adapter = new ArrayAdapter<String>(context, R.layout.list_item_sensor, R.id.textItem , listString );
						        setListAdapter(adapter);
