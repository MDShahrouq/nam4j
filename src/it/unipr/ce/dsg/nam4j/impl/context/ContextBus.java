...
public class ContextBus extends FunctionalModule implements IContextEventObserver {
	...
	public ContextBus(NetworkedAutonomicMachine nam, String id) {
		super(nam);
	 ...
	 */
	public void subscribe(String contextEventName, String functionalModuleId, String sender, ContextPeer peer, PeerList list, int hops) {
	 ...
	 *            if full mesh structure is in use, the value must be negative
	 */
	public void unsubscribe(String contextEventName, String functionalModuleId, String sender, ContextPeer peer, PeerList list, int hops) {
	 ...
	 * @param peer
	 */
	public void publish(ContextEvent contextEvent, ContextPeer peer) {
	 ...
	 */
	@Override
	public void manageRequest(JsonObject peerMsg, ContextPeer peer, PeerList list) {
